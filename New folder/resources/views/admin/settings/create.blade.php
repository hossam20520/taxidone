    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('draw_on_every_travel_a') ? 'is-invalid' : '' }}" type="number" name="draw_on_every_travel_a" id="draw_on_every_travel_a" value="{{ old('draw_on_every_travel_a', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('draw_on_every_travel_p') ? 'is-invalid' : '' }}" type="number" name="draw_on_every_travel_p" id="draw_on_every_travel_p" value="{{ old('draw_on_every_travel_p', '') }}" step="1">
