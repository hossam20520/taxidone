...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.subscriptiondriver.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.subscriptiondrivers.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('subscription_date') ? 'is-invalid' : '' }}" type="text" name="subscription_date" id="subscription_date" value="{{ old('subscription_date') }}">
