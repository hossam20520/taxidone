...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.travel.update", [$travel->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="travel">{{ trans('cruds.travel.fields.travel') }}</label>
                <input class="form-control {{ $errors->has('travel') ? 'is-invalid' : '' }}" type="text" name="travel" id="travel" value="{{ old('travel', $travel->travel) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('travel_cost') ? 'is-invalid' : '' }}" type="number" name="travel_cost" id="travel_cost" value="{{ old('travel_cost', $travel->travel_cost) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('travel_destination_from') ? 'is-invalid' : '' }}" type="text" name="travel_destination_from" id="travel_destination_from" value="{{ old('travel_destination_from', $travel->travel_destination_from) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('travel_destnitation_to') ? 'is-invalid' : '' }}" type="text" name="travel_destnitation_to" id="travel_destnitation_to" value="{{ old('travel_destnitation_to', $travel->travel_destnitation_to) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('travel_destance') ? 'is-invalid' : '' }}" type="number" name="travel_destance" id="travel_destance" value="{{ old('travel_destance', $travel->travel_destance) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('arrival_time') ? 'is-invalid' : '' }}" type="text" name="arrival_time" id="arrival_time" value="{{ old('arrival_time', $travel->arrival_time) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('client') ? 'is-invalid' : '' }}" name="client_id" id="client_id">
                    @foreach($clients as $id => $entry)
                        <option value="{{ $id }}" {{ (old('client_id') ? old('client_id') : $travel->client->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('driver') ? 'is-invalid' : '' }}" name="driver_id" id="driver_id">
                    @foreach($drivers as $id => $entry)
                        <option value="{{ $id }}" {{ (old('driver_id') ? old('driver_id') : $travel->driver->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('travel_status') ? 'is-invalid' : '' }}" name="travel_status" id="travel_status" required>
                    ...
                    @foreach(App\Models\Travel::TRAVEL_STATUS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('travel_status', $travel->travel_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
